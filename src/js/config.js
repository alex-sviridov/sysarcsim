...
export const ELEM_DEFS = {
  WebServer: {
    label:   'Web Server',
    inputs:  { SQL: { demand: 30 }, Storage: { demand: 5, multipath: true } },
  ...
  DirectAttachStorage: {
    label:   'Direct Attach Storage',
    inputs:  {},
    outputs: { Storage: { supply: 30, multipath: false } },
    color:   '#b45309',
    icon:    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><rect x="3" y="4" width="14" height="12" rx="1" fill="none" stroke="currentColor" stroke-width="1.5"/><line x1="3" y1="8" x2="17" y2="8" stroke="currentColor" stroke-width="1.5"/><line x1="3" y1="12" x2="17" y2="12" stroke="currentColor" stroke-width="1.5"/><circle cx="15" cy="6" r="0.8" fill="currentColor"/></svg>',
  },
};
